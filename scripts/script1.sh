...
read var1
sudo docker exec autodoc  mysql -uroot -e "use $bdname; CREATE TABLE $tlname ("id" int(11) PRIMARY KEY NOT NULL AUTO_INCREMENT,  $var1 varchar(70) COLLATE utf8mb4_spanish_ci NOT NULL, "fecha" datetime NOT NULL DEFAULT CURRENT_TIMESTAMP);"
echo "############################################"

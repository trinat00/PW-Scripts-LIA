...
read var3
echo "Introduzca en nombre de la variable 4"
read var4
sudo docker exec autolamp  mysql -uroot -e "use $bdname; CREATE TABLE $tlname ("id" int(11) PRIMARY KEY NOT NULL AUTO_INCREMENT,  $var1 varchar(70) COLLATE utf8mb4_spanish_ci NOT NULL,  $var2 varchar(70) COLLATE utf8mb4_spanish_ci NOT NULL, $var3 varchar(70) COLLATE utf8mb4_spanish_ci NOT NULL, $var4 varchar(70) COLLATE utf8mb4_spanish_ci NOT NULL,  "fecha" datetime NOT NULL DEFAULT CURRENT_TIMESTAMP);"
echo "############################################"
...
echo "El nombre de la variable 2 es : $var4"
